...
class ItemList:
    ...
    def __init__(self):
        ...
        ItemList.__id += 1
        # А для чего хранить в списке итемов еще и каталоги?
        # Этот объект же используется еще и для оформления заказов для пользователя
        # огромное количество информации потащится в заказы пользователей
